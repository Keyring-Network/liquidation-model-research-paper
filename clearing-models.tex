...
\vspace{2cm}
{\large A. McFarlane\footnotemark[1] \quad S. Gujrati\footnotemark[1] \quad J. Zierold\footnotemark[1]\par}
\footnotetext[1]{Keyring.Network Ltd.}
\begingroup
...
\begin{figure}[h]
\centering
\resizebox{\textwidth}{!}{\input{vault-flow-diagram.tex}}
